            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('EditDelivery_') }}" enctype="multipart/form-data" id="form-disc"
                            class="forms-sample">
                            <input type="hidden" name="id" class="form-control value"
                            id="exampleInputName1" value="{{ $allDeli->id }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control name"
                                            id="exampleInputName1" placeholder="Nhập phương thức giao hàng"
                                            value="{{ $allDeli->name }}">
                                        <span
                                            style="font-size: 15px; color: #f33a58; line-height: 3px; padding-top: 10px;  display: block;"
                                            class="form-message"></span>
