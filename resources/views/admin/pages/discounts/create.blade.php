            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('storeDiscount_code') }}" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control code"
                                            id="exampleInputName1" placeholder="Nhập mã giảm giá">
                                        <span
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="discount" min="0" class="form-control discount"
                                            id="exampleInputName1" placeholder="Nhập số tiền giảm giá">
                                        <span
                                            style="font-size: 15px; color: #f33a58; line-height: 3px; padding-top: 10px;  display: block;"
                                            class="form-message"></span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_time" class="form-control start_time"
                                            id="exampleInputName1" placeholder="Nhập ngày đăng">
                                        <span
                                            style="font-size: 15px; color: #f33a58; line-height: 3px; padding-top: 10px;  display: block;"
                                            class="form-message"></span>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_time" class="form-control end_time"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantity" min="0" class="form-control quantity"
                                            id="exampleInputName1" placeholder="Nhập số lượng">
                                        <span
                                            style="font-size: 15px; color: #f33a58; line-height: 3px; padding-top: 10px;  display: block;"
                                            class="form-message"></span>
