    ...
    <div class="content-wrapper">
        <div class="row">
                            ...
                            <table id="recent-purchases-listing" class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($details as $detail)
                                        <tr>
                                            <td>{{ $detail->name }}</td>
                                            <td><img src="{{ asset('images/products/' . $detail->Product->image) }}"
            ...
            <div class="col-md-4 ">
                <div class="order-info-user">
                    <div class="info-user">
                        ...
                        <div class="info-user-content">
                            <span><img width="50px" src="{{ asset('images/users/' . $order->User->image) }}"
                                    alt=""></span>
                ...
                <div class="order-info-user mt-2">
                    <div class="info-user-content">
                        <p>Người nhận: <span>{{ $order->Address->name }}</span></p>
                    </div>
                    <div class="info-user-content">
                        <p>SĐT: <span>0{{ $order->Address->phone }}</span></p>
                    </div>
                    <div class="info-user-content">
                        <p>Địa chỉ: <span>{{ $order->Address->address }}</span></p>
                    </div>
                    <div class="info-user-content">
