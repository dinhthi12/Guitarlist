                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-4" style="float: left; margin:-2% 0% 2% -1%;">
                            ...
                            <form action="{{route('searchNameUser')}}" method="GET">
                                @csrf
                                <div class="input-group">
                                    <input style="margin-top: 2%;" name="keywords" type="search" class="form-control"
                                ...
                                <tbody>
                                    @foreach ($allUser as $user)
                                        <tr>
                                            <td>{{ $user->id }}</td>
                                            <td>{{ $user->name }}</td>
                                            <td><img src="{{ asset('images/users/' . $user->image) }}" alt=""
                                            ...
                                            <td>
                                                <a class="badge badge-danger rounded"
                                                    ...
                                                    href="{{route('deleteUser',$user->id)}}"><i
