        ...
        <div class="container">
            <div class="row">
                                ...
                                @if (isset($allProCart) && count($allProCart) > 0)
                                    @foreach ($allProCart as $pro)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="cart-total">{{ number_format($pro['total'], 0, '.', '.') }} VNĐ
                                                </h5>
                                            </td>
                                            <td>
                                                <a href="{{ route('deleteItemCart', $pro['name']) }}"
                                                ...
                                                <div class="form-select" id="default-select">
                                                    ...
                                                    @else
                                                        <input type="text" name="name" disabled
                                                            value="Vui lòng thêm địa chỉ giao hàng" class="single-input">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-select" id="default-select">
                                                    <select id="ship_select" name="deli_id" style="display: none;">
                                                        @foreach ($delivery as $deli)
                                                            <option data-value="{{ $deli->value }}"
                                                                value="{{ $deli->id }}">{{ $deli->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                ...
                <div class="payment_info col-md-3">
                    ...
                    <br>
                    <div class="payment_item">
                        <p>Giỏ hàng: <span>VNĐ</span> <span
                                data-total="{{ $cart_total }}">{{ number_format($cart_total, 0, '.', '.') }}</span>
                        </p>
                        <p>Giảm Giá: <span>VNĐ</span> <span>
                                @if (isset($disc[0]))
                                    {{ number_format($disc[0]['discount'], 0, '.', '.') }}
                                @endif
                            </span> </p>
                    </div>
                </div>
