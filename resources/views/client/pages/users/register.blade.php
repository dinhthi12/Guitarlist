            ...
            <div class="container">
                <div class="card bg-light" style="border: none">
                    <article class="card-body mx-auto" style="max-width: 400px;">
                        ...
                        <p>
                            <a style="color: #fff" onclick="alert('Chức năng đang phát triển thêm')"
                                class="btn btn-block btn-google"> <i class="fa fa-google"></i> Đăng nhập với Google</a>
                            <a style="color: #fff" onclick="alert('Chức năng đang phát triển thêm')"
                                class="btn btn-block btn-facebook"> <i class="fa fa-facebook"></i> Đăng nhập với
                                facebook</a>
                        </p>
                        ...
                        <form method="POST" action="{{ route('register') }}" id ="form-register"
                            ...
                            <div class="form-group input-group">
                                ...
                                <input name="" class="form-control password_confirmation"
                            ...
                            <div class="form-group input-group">
                                ...
                                <input name="address" class="form-control address" placeholder="Địa chỉ của bạn"
                                    type="text">
                                <span style="font-size: 15px; color: #f33a58;width: 100%;" class="form-message"></span>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input name="phone" class="form-control myPhone" placeholder="Số điện thoại"
                                    type="text">
                                <span style="font-size: 15px; color: #f33a58;width: 100%;" class="form-message"></span>
                            </div>
                            <div class="form-group input-group">
                                ...
                                <input name="file_upload" class="form-control avatar" placeholder="Ảnh của bạn"
                                    type="file">
                                <span style="font-size: 15px; color: #f33a58;width: 100%;" class="form-message"></span>
                            </div><!-- form-group// -->
                            <!-- form-group end.// -->
